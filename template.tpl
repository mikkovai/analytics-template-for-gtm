...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Piwik PRO Analytics - customised",
  "categories": [
    "ANALYTICS"
  ],
  "brand": {
  ...
  "description": "Privacy-friendly customer journey analytics. With modifications to allow appendToTrackingUrl and some feature removals.",
  "containerContexts": [
    "WEB"
  ]
}
